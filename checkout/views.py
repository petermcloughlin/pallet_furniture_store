...
from .models import CustomerOrder, CustomerOrderLineItem
    ...
    if request.method == "POST":
        ...
        if order_form.is_valid():
            ...
            for item_id, item_data in bag.items():
                try:
                    product = StoreProduct.objects.get(id=item_id)
                    if isinstance(item_data, int):
                        order_line_item = CustomerOrderLineItem(
                            order=order,
                            product=product,
                            quantity=item_data,
                        )
                    ...
                    messages.error(request, "One of these products wasn't found. Contact us for assistance.")
                    order.delete()
